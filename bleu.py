...
def add_bleu_args_(parser):
    parser.add_argument('--lowercase', '-lc', action='store_true', default=False,
                        help='whether to use case insensitive bleu metric')
    parser.add_argument('--references', '-r', action='append', required=True,
    ...
    parser.add_argument('--moses_scripts_path', '-msp', help='moses scripts path')
